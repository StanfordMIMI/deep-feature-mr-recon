...
class SSFD(Metric):
    ...
    ..  [1] Adamson, Philip M., et al.
        ...
        [2] Adamson, Philip M., et al.
        Using Deep Feature Distances for Evaluating MR Image Reconstruction Quality. 2023.
        https://openreview.net/forum?id=AUiZyqYiGb&noteId=AUiZyqYiGb 
    """
